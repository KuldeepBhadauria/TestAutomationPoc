package com.poc.test.automation.utils;
...
public class WebdriverUtils {
	...
	// Should be changed
	public static final String username = "kuldeepbhadauria_3YbtKy";
	public static final String accessKey = "GPCt4t3pXpqYzNSsatWn";
	...
	public static WebDriver getDriverInstanceForRemote() throws MalformedURLException {
		...
		caps.setCapability("project", "Loyality BI Reports Automation");
		caps.setCapability("build", "1.0");
		caps.setCapability("name", "Reports Automation Tests");
